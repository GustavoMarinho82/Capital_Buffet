    ...
    <BODY>
        ...
        include('../conexao.php');
            ...
            if (mysqli_num_rows($consulta) == 0) {
                ...
                $sql = "UPDATE utilitarios SET nome_utilitario='$nome', preco_utilitario=$preco, estoque_utilitario=$estoque, descricao_utilitario='$descricao' WHERE id_utilitario=$id_utilitario";
